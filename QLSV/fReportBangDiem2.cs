...
namespace QLSV
{
    public partial class fReportBangDiem2 : Form
    {
        EFDbContext db = new EFDbContext();
        private string TenSV;
        public fReportBangDiem2(string TenSV)
        {
            InitializeComponent();
            this.TenSV = TenSV;
        }

        private void fReportBangDiem2_Load(object sender, EventArgs e)
        {
            ...
            reportViewer.LocalReport.ReportPath = Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName, "rDiemSVTheoTen.rdlc");
